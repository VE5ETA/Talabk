...
export default function OldOrder(props) {
              ...
              >
                <div className="d-flex justify-content-between">
                  ...
                  <small>
                    ...
                    {
                      <ReactTimeAgo
                        date={Date.parse(props.orderDate)}
                        locale="en-US"
                      />
                    }
                  </small>
                ...
                <p>
                  Order state:
                  {props.orderState === "accepted" ||
                  props.orderState === "done" ? (
                    ...
                    <>
                      ...
                      <li className="list-group-item d-flex justify-content-between align-items-start">
                        <div className="ms-2 me-auto">
                          <div className="fw-bold">
                            Reservation time:{" "}
                            {props.reservationInfo.reservationTime}
                          </div>
                        </div>
                      </li>
                    </>
  ...
  return (
    <tr className="">
      ...
      {/* <a href={`tel:${props.customerNumber}`} /> */}
      <td>
        <a href={`tel:${props.customerNumber}`} className="">
          {props.customerNumber}
        </a>
      </td>
      <td className="">{props.orderType}</td>
      <td className="">{props.orderState}</td>
      <td className="">{props.subTotal}</td>
      <td className="">
